...
module RDF::Vocab
  ...
  class DIO < RDF::StrictVocabulary("https://w3id.org/dio#")
    ...
    term :DesignGoal,
      ...
      equivalentClass: "dio:DesignIssue".freeze,
      label: "Design Goal".freeze,
      subClassOf: term(
          intersectionOf: list("dio:DesignIntentArtifact".freeze, term(
            allValuesFrom: "dio:AlternativeSolution".freeze,
            onProperty: "dio:hasAlternativeSolution".freeze,
            type: "owl:Restriction".freeze
          ), term(
            allValuesFrom: "dio:MandatedSolution".freeze,
            onProperty: "dio:hasMandatedSolution".freeze,
            type: "owl:Restriction".freeze
          ), term(
            onProperty: "dio:hasMandatedSolution".freeze,
            "owl:maxQualifiedCardinality": "1".freeze,
            "owl:onClass": "dio:MandatedSolution".freeze,
            type: "owl:Restriction".freeze
          )),
          type: "owl:Class".freeze
        ),
    ...
    term :DesignIntentArtifact,
      ...
      subClassOf: term(
          intersectionOf: list(term(
            onProperty: "prov:wasAttributedTo".freeze,
            "owl:onClass": "prov:Agent".freeze,
            "owl:qualifiedCardinality": "1".freeze,
            type: "owl:Restriction".freeze
          ), term(
            onProperty: "prov:generatedAtTime".freeze,
            "owl:onDataRange": "xsd:dateTime".freeze,
            "owl:qualifiedCardinality": "1".freeze,
            type: "owl:Restriction".freeze
          ), term(
            onProperty: "dio:version".freeze,
    ...
    property :fulfillsRequirement,
      ...
      inverseOf: "dio:requirementFulfilledBy".freeze,
    ...
    property :generatedByIntent,
      ...
      inverseOf: "dio:generatesIssue".freeze,
    ...
    property :identifiedByRequirement,
      ...
      inverseOf: "dio:identifies".freeze,
    ...
    property :providesAlternativeSolution,
      ...
      inverseOf: "dio:hasAlternativeSolution".freeze,
    ...
    property :providesMandatedSolution,
      ...
      inverseOf: "dio:hasMandatedSolution".freeze,
