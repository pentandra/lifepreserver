...
module LifePreserver::Vocab
  VIVO = Class.new(RDF::StrictVocabulary("http://vivoweb.org/ontology/core#")) do

    # Ontology definition
    ontology :"http://vivoweb.org/ontology/core#",
      label: "VIVO Core Ontology".freeze,
    ...
    term :AcademicDegree,
      "http://purl.obolibrary.org/obo/IAO_0000112": "B.A. Bachelor of Arts".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000114": "http://purl.obolibrary.org/obo/IAO_0000120".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000115": "An academic degree at any level, both as \n        reported by individuals for employment and as offered by academic degree programs.".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000116": "The ObjectProperty relates is used to associate an AcademicDegree with an AwardedDegree.  A preferred\n        approach would be to recognize the AwardedDegree as an information artifact which is the output of an AcademicDegree process.\n        This would eliminate the use of relates and relatedBy in the\n        representation of Academic Degrees and Awarded Degrees, provide correct subsumption, and avoid the use of vivo:Relationship. Further, we could\n        rename AwardedDegree AcademicDegree (!) and rename AcademicDegree to AcademicDegreeProcess and eliminate the need for\n        the EducationalProcess currently in the model.\n        ".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000117": "PERSON: Michael Conlon".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000119": "Merriam Webster (https://www.merriam-webster.com/dictionary/degree)".freeze,
      label: "Academic Degree".freeze,
      subClassOf: [term(
          "http://www.w3.org/2002/07/owl#minQualifiedCardinality": "1".freeze,
          "http://www.w3.org/2002/07/owl#onDataRange": "http://www.w3.org/2001/XMLSchema#nonNegativeInteger".freeze,
          onProperty: "http://vivoweb.org/ontology/core#abbreviation".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://www.w3.org/2000/01/rdf-schema#Literal".freeze,
          onProperty: "http://vivoweb.org/ontology/core#abbreviation".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :AdvisingRelationship,
      ...
      subClassOf: ["http://vivoweb.org/ontology/core#Relationship".freeze, term(
          allValuesFrom: "http://vivoweb.org/ontology/core#DateTimeInterval".freeze,
          onProperty: "http://vivoweb.org/ontology/core#dateTimeInterval".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://www.w3.org/2002/07/owl#Thing".freeze,
          onProperty: "http://vivoweb.org/ontology/core#hasSubjectArea".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://vivoweb.org/ontology/core#AdviseeRole".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://vivoweb.org/ontology/core#AdvisorRole".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://xmlns.com/foaf/0.1/Person".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :AdvisorRole,
    ...
    term :Authorship,
      ...
      subClassOf: ["http://vivoweb.org/ontology/core#Relationship".freeze, term(
          allValuesFrom: "http://www.w3.org/2001/XMLSchema#boolean".freeze,
          onProperty: "http://vivoweb.org/ontology/core#hideFromDisplay".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://purl.obolibrary.org/obo/IAO_0000030".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://xmlns.com/foaf/0.1/Agent".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Award,
      "http://purl.obolibrary.org/obo/IAO_0000112": "The Wiley Prize in Biomedicine is awarded each year to a researcher for outstanding\n        contributions to biomedicine.".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000114": "http://purl.obolibrary.org/obo/IAO_0000120".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000115": "A recognition of outstanding work or action.".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000116": "The ObjectProperty relates is used to associate an Award with an AwardReceipt.  A preferred\n        approach would be to recognize the AwardReceipt as an information artifact which is the output of the Award process.\n        The award receipt is about the recipient of the award.  This would eliminate the use of relates and relatedBy in the\n        representation of Awards and AwardReceipts, provide correct subsumption, and avoid the use of vivo:Relationship.  We\n        could then rename AwardReceipt to Award (!) and Award to AwardProcess to reflect their natures (this is why ontologies use numbered \n        class names -- to avoid renaming)\n        ".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000117": "PERSON: Michael Conlon".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000119": "Merriam Webster (https://www.merriam-webster.com/dictionary/award)".freeze,
    ...
    term :AwardReceipt,
      ...
      subClassOf: ["http://vivoweb.org/ontology/core#Relationship".freeze, term(
          ...
          allValuesFrom: "http://vivoweb.org/ontology/core#DateTimeValue".freeze,
          onProperty: "http://vivoweb.org/ontology/core#dateTimeValue".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://www.w3.org/2000/01/rdf-schema#Literal".freeze,
          onProperty: "http://vivoweb.org/ontology/core#description".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://xmlns.com/foaf/0.1/Organization".freeze,
          onProperty: "http://vivoweb.org/ontology/core#assignedBy".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://vivoweb.org/ontology/core#Award".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://xmlns.com/foaf/0.1/Agent".freeze,
    ...
    term :AwardedDegree,
      ...
      subClassOf: ["http://vivoweb.org/ontology/core#Relationship".freeze, term(
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://vivoweb.org/ontology/core#AcademicDegree".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://xmlns.com/foaf/0.1/Person".freeze,
    ...
    term :BlogPosting,
      ...
      subClassOf: ["http://purl.org/ontology/bibo/Article".freeze, term(
          allValuesFrom: "http://vivoweb.org/ontology/core#Blog".freeze,
          onProperty: "http://vivoweb.org/ontology/core#hasPublicationVenue".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Building,
      ...
      subClassOf: ["http://vivoweb.org/ontology/core#Facility".freeze, term(
          allValuesFrom: "http://vivoweb.org/ontology/core#Facility".freeze,
          onProperty: "http://purl.obolibrary.org/obo/BFO_0000050".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://vivoweb.org/ontology/core#Room".freeze,
          onProperty: "http://purl.obolibrary.org/obo/BFO_0000051".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Campus,
    ...
    term :Catalog,
      ...
      subClassOf: ["http://purl.org/ontology/bibo/Document".freeze, term(
          allValuesFrom: "http://www.w3.org/2000/01/rdf-schema#Literal".freeze,
          onProperty: "http://vivoweb.org/ontology/core#placeOfPublication".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://xmlns.com/foaf/0.1/Organization".freeze,
          onProperty: "http://vivoweb.org/ontology/core#publisher".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Center,
    ...
    term :Committee,
      ...
      subClassOf: "http://xmlns.com/foaf/0.1/Group".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Company,
    ...
    term :ConferencePaper,
      ...
      subClassOf: ["http://purl.org/ontology/bibo/Article".freeze, term(
          allValuesFrom: "http://purl.org/ontology/bibo/Conference".freeze,
          onProperty: "http://purl.org/ontology/bibo/presentedAt".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :Contract,
      ...
      subClassOf: ["http://vivoweb.org/ontology/core#Relationship".freeze, term(
          allValuesFrom: "http://purl.obolibrary.org/obo/IAO_0000030".freeze,
          onProperty: "http://vivoweb.org/ontology/core#supportedInformationResource".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://vivoweb.org/ontology/core#DateTimeInterval".freeze,
          onProperty: "http://vivoweb.org/ontology/core#dateTimeInterval".freeze,
          ...
          allValuesFrom: "http://www.w3.org/2000/01/rdf-schema#Literal".freeze,
          onProperty: "http://purl.org/ontology/bibo/abstract".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://xmlns.com/foaf/0.1/Organization".freeze,
          onProperty: "http://vivoweb.org/ontology/core#assignedBy".freeze,
          ...
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://purl.obolibrary.org/obo/BFO_0000023".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://xmlns.com/foaf/0.1/Agent".freeze,
    ...
    term :Course,
      ...
      label: "Course".freeze,
      subClassOf: ["http://purl.org/NET/c4dm/event.owl#Event".freeze, term(
          allValuesFrom: "http://www.w3.org/2000/01/rdf-schema#Literal".freeze,
          onProperty: "http://vivoweb.org/ontology/core#courseCredits".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Credential,
      "http://purl.obolibrary.org/obo/IAO_0000112": "A driver's license is the result of a credentialing process".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000114": "http://purl.obolibrary.org/obo/IAO_0000120".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000115": "An attestation of qualification, competence, or authority issued to an individual by a third \n        party with a relevant or  de facto authority or assumed competence to do so.".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000116": "The ObjectProperty relates is used to associate a Credential with an IssuedCredential.  A preferred\n        approach would be to recognize the IssuedCredential as an information artifact which is the output of the Credential process.\n        The IssuedCredential is about the recipient of the issued credential.  This would eliminate the use of relates and relatedBy in the\n        representation of Credentials and IssuedCredentials, provide correct subsumption, and avoid the use of vivo:Relationship.  We could\n        then rename IssuedCredential to Credential (!) and Credential to CredentialingProcess which would reflect their true nature.  Other\n        ontologies used numbered class names to avoid the need to rename in such cases.\n        ".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000117": "PERSON: Michael Conlon".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000119": "Merriam Webster (https://www.merriam-webster.com/dictionary/credential)".freeze,
      label: "Credential".freeze,
      subClassOf: [term(
          allValuesFrom: "http://vivoweb.org/ontology/core#GeographicLocation".freeze,
          onProperty: "http://vivoweb.org/ontology/core#validIn".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://www.w3.org/2002/07/owl#Thing".freeze,
          onProperty: "http://vivoweb.org/ontology/core#hasSubjectArea".freeze,
          ...
          allValuesFrom: "http://xmlns.com/foaf/0.1/Organization".freeze,
          onProperty: "http://vivoweb.org/ontology/core#hasGoverningAuthority".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Database,
    ...
    term :Dataset,
      ...
      subClassOf: ["http://purl.org/ontology/bibo/Document".freeze, term(
          ...
          onProperty: "http://purl.org/spar/cito/isCitedAsDataSourceBy".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :DateTimeValuePrecision,
      "http://purl.obolibrary.org/obo/IAO_0000112": "A dateTimeValue may have yearDateTimePrecision indicating that only the year is known.".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000114": "http://purl.obolibrary.org/obo/IAO_0000120".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000115": "The precision of a DateTimeValue".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000116": "DateTimeValuePrecisions are represented as individuals of this class.".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000117": "PERSON: Michael Conlon".freeze,
      label: "DateTime Value Precision".freeze,
      subClassOf: "http://purl.obolibrary.org/obo/BFO_0000019".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Department,
    ...
    term :EducationalProcess,
      ...
      subClassOf: ["http://purl.obolibrary.org/obo/BFO_0000015".freeze, term(
          allValuesFrom: "http://vivoweb.org/ontology/core#DateTimeInterval".freeze,
          onProperty: "http://vivoweb.org/ontology/core#dateTimeInterval".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://www.w3.org/2001/XMLSchema#string".freeze,
          onProperty: "http://vivoweb.org/ontology/core#supplementalInformation".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :EmeritusFaculty,
      ...
      subClassOf: "http://xmlns.com/foaf/0.1/Person".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :EmeritusProfessor,
      ...
      subClassOf: ["http://vivoweb.org/ontology/core#EmeritusFaculty".freeze, "http://xmlns.com/foaf/0.1/Person".freeze],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Equipment,
      ...
      subClassOf: ["http://purl.obolibrary.org/obo/BFO_0000040".freeze, term(
          allValuesFrom: "http://www.w3.org/2001/XMLSchema#string".freeze,
          onProperty: "http://vivoweb.org/ontology/core#freetextKeyword".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :EventSeries,
      ...
      subClassOf: ["http://purl.obolibrary.org/obo/BFO_0000015".freeze, term(
          ...
          allValuesFrom: "http://www.w3.org/2000/01/rdf-schema#Literal".freeze,
          onProperty: "http://vivoweb.org/ontology/core#contactInformation".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://www.w3.org/2000/01/rdf-schema#Literal".freeze,
          onProperty: "http://vivoweb.org/ontology/core#description".freeze,
    ...
    term :F1000Link,
      ...
      subClassOf: "http://www.w3.org/2006/vcard/ns#URL".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Facility,
      ...
      subClassOf: ["http://purl.obolibrary.org/obo/BFO_0000029".freeze, term(
          allValuesFrom: "http://purl.obolibrary.org/obo/BFO_0000029".freeze,
          onProperty: "http://purl.obolibrary.org/obo/BFO_0000050".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://vivoweb.org/ontology/core#Facility".freeze,
    ...
    term :FundingOrganization,
      equivalentClass: term(
          onProperty: "http://vivoweb.org/ontology/core#assigns".freeze,
          someValuesFrom: "http://vivoweb.org/ontology/core#Grant".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ),
    ...
    term :GeographicLocation,
      ...
      subClassOf: ["http://vivoweb.org/ontology/core#Location".freeze, term(
          allValuesFrom: "http://vivoweb.org/ontology/core#GeographicLocation".freeze,
          onProperty: "http://purl.obolibrary.org/obo/BFO_0000050".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
    ...
    term :IssuedCredential,
      ...
      subClassOf: ["http://vivoweb.org/ontology/core#Relationship".freeze, term(
          allValuesFrom: "http://vivoweb.org/ontology/core#DateTimeValue".freeze,
          onProperty: "http://vivoweb.org/ontology/core#dateIssued".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://vivoweb.org/ontology/core#DateTimeValue".freeze,
          onProperty: "http://vivoweb.org/ontology/core#expirationDate".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://vivoweb.org/ontology/core#GeographicLocation".freeze,
          onProperty: "http://vivoweb.org/ontology/core#validIn".freeze,
          ...
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://vivoweb.org/ontology/core#Credential".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://xmlns.com/foaf/0.1/Agent".freeze,
    ...
    term :Position,
      ...
      subClassOf: ["http://vivoweb.org/ontology/core#Relationship".freeze, term(
          ...
          allValuesFrom: "http://www.w3.org/2001/XMLSchema#int".freeze,
          onProperty: "http://vivoweb.org/ontology/core#rank".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://xmlns.com/foaf/0.1/Organization".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://vivoweb.org/ontology/core#relates".freeze,
          someValuesFrom: "http://xmlns.com/foaf/0.1/Person".freeze,
    ...
    term :Project,
      ...
      subClassOf: ["http://purl.obolibrary.org/obo/BFO_0000015".freeze, term(
          ...
          allValuesFrom: "http://vivoweb.org/ontology/core#GeographicRegion".freeze,
          onProperty: "http://vivoweb.org/ontology/core#geographicFocus".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://www.w3.org/2000/01/rdf-schema#Literal".freeze,
          onProperty: "http://vivoweb.org/ontology/core#description".freeze,
    ...
    property :affiliatedOrganization,
      domain: "http://xmlns.com/foaf/0.1/Organization".freeze,
    ...
    property :assignedBy,
      ...
      inverseOf: "http://vivoweb.org/ontology/core#assigns".freeze,
      label: "assigned by".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    property :assignee,
      domain: "http://purl.org/ontology/bibo/Patent".freeze,
      inverseOf: "http://vivoweb.org/ontology/core#assigneeFor".freeze,
    ...
    property :conceptAssociatedWith,
      inverseOf: "http://vivoweb.org/ontology/core#hasAssociatedConcept".freeze,
      label: "concept for".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    property :confirmedOrcidId,
      comment: "Indicates that the Orcid ID has been confirmed by this Person".freeze,
      label: "Orcid ID confirmation".freeze,
    ...
    property :contributingRole,
      inverseOf: "http://vivoweb.org/ontology/core#roleContributesTo".freeze,
    ...
    property :distributesFundingFrom,
      ...
      inverseOf: "http://vivoweb.org/ontology/core#providesFundingThrough".freeze,
    ...
    property :equipmentFor,
      ...
      inverseOf: "http://vivoweb.org/ontology/core#hasEquipment".freeze,
      label: "equipment for".freeze,
      range: "http://xmlns.com/foaf/0.1/Organization".freeze,
    ...
    property :facilityFor,
      ...
      inverseOf: "http://vivoweb.org/ontology/core#hasFacility".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    property :featuredIn,
      ...
      inverseOf: "http://vivoweb.org/ontology/core#features".freeze,
    ...
    property :fundingVehicleFor,
      ...
      inverseOf: "http://vivoweb.org/ontology/core#hasFundingVehicle".freeze,
      label: "provides funding for".freeze,
      subPropertyOf: "http://vivoweb.org/ontology/core#supports".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    property :geographicFocus,
      inverseOf: "http://vivoweb.org/ontology/core#geographicFocusOf".freeze,
    ...
    property :governingAuthorityFor,
      domain: "http://xmlns.com/foaf/0.1/Organization".freeze,
      inverseOf: "http://vivoweb.org/ontology/core#hasGoverningAuthority".freeze,
      label: "governing authority for".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    property :grantDirectCosts,
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class".freeze,
          unionOf: list("http://vivoweb.org/ontology/core#Contract".freeze, "http://vivoweb.org/ontology/core#Grant".freeze)
        ),
      label: "direct costs".freeze,
      type: ["http://www.w3.org/2002/07/owl#DatatypeProperty".freeze, "http://www.w3.org/2002/07/owl#FunctionalProperty".freeze]
    property :grantSubcontractedThrough,
      domain: "http://vivoweb.org/ontology/core#Grant".freeze,
      inverseOf: "http://vivoweb.org/ontology/core#subcontractsGrant".freeze,
    ...
    property :hasCollaborator,
      domain: "http://xmlns.com/foaf/0.1/Agent".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000112": "Fran has collaborator Jim, they work together regularly.".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000114": "http://purl.obolibrary.org/obo/IAO_0000120".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000115": "Two agents are collaborators if they work together to produce common results.".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000117": "PERSON: Michael Conlon".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000119": "Merriam Webster (https://www.merriam-webster.com/dictionary/collaborator)".freeze,
    ...
    property :hasFundingVehicle,
      ...
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    property :hasGoverningAuthority,
    ...
    property :hasPredecessorOrganization,
      domain: "http://xmlns.com/foaf/0.1/Organization".freeze,
      inverseOf: "http://vivoweb.org/ontology/core#hasSuccessorOrganization".freeze,
      label: "predecessor organization".freeze,
      range: "http://xmlns.com/foaf/0.1/Organization".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    property :hasPrerequisite,
      domain: "http://vivoweb.org/ontology/core#Course".freeze,
      inverseOf: "http://vivoweb.org/ontology/core#prerequisiteFor".freeze,
    ...
    property :hasProceedings,
      ...
      inverseOf: "http://vivoweb.org/ontology/core#proceedingsOf".freeze,
      label: "proceedings".freeze,
      range: "http://purl.org/ontology/bibo/Proceedings".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    property :hasPublicationVenue,
      inverseOf: "http://vivoweb.org/ontology/core#publicationVenueFor".freeze,
      label: "published in".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    property :hasResearchArea,
      inverseOf: "http://vivoweb.org/ontology/core#researchAreaOf".freeze,
    ...
    property :hasSubjectArea,
      inverseOf: "http://vivoweb.org/ontology/core#subjectAreaOf".freeze,
    ...
    property :informationResourceSupportedBy,
      ...
      inverseOf: "http://vivoweb.org/ontology/core#supportedInformationResource".freeze,
    ...
    property :nihmsid,
      ...
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty".freeze
    property :offeredBy,
      inverseOf: "http://vivoweb.org/ontology/core#offers".freeze,
    ...
    property :orcidId,
      ...
      "http://vitro.mannlib.cornell.edu/ns/vitro/0.7#stubObjectPropertyAnnot": "true".freeze,
    ...
    property :overview,
      domain: "http://xmlns.com/foaf/0.1/Agent".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000112": "My research focuses on diseases of pine crops in the southeastern United States.".freeze,
      "http://purl.obolibrary.org/obo/IAO_0000115": "Short text for presentation describing the agent's purpose, activities, and/or accomplishments.".freeze,
    ...
    property :publisher,
      ...
      inverseOf: "http://vivoweb.org/ontology/core#publisherOf".freeze,
      label: "publisher".freeze,
      range: "http://xmlns.com/foaf/0.1/Organization".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    ...
    property :relatedBy,
      ...
      inverseOf: "http://vivoweb.org/ontology/core#relates".freeze,
    ...
    property :sponsoredBy,
      ...
      inverseOf: "http://vivoweb.org/ontology/core#sponsors".freeze,
    ...
    property :supportedBy,
      ...
      inverseOf: "http://vivoweb.org/ontology/core#supports".freeze,
      label: "supported by".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    ...
    property :translatorOf,
      ...
      range: term(
          ...
          unionOf: list(term(
            ...
            "http://purl.obolibrary.org/obo/IAO_0000112": ["Collection of information resources that have a unified identity. Archives, museums and libraries often acquire collections on specific subjects and from distinguished authors or researchers. Also includes collections of resources bundled into a license.".freeze,"Hill Ornithology Collection; Wiley Interscience Online Books Biochemisty Collection".freeze],
            "http://purl.obolibrary.org/obo/IAO_0000115": "Collection of information resources that have a unified identity".freeze,
            "http://www.w3.org/2003/06/sw-vocab-status/ns#term_status": "stable".freeze,
            isDefinedBy: "http://purl.org/ontology/bibo/".freeze,
            label: "Collection".freeze,
            subClassOf: [term(
              allValuesFrom: "http://www.w3.org/2000/01/rdf-schema#Literal".freeze,
              onProperty: "http://purl.org/ontology/bibo/oclcnum".freeze,
              type: "http://www.w3.org/2002/07/owl#Restriction".freeze
            ).freeze,"http://purl.obolibrary.org/obo/IAO_0000030".freeze],
            type: "http://www.w3.org/2002/07/owl#Class".freeze
          ), term(
            ...
            "http://purl.obolibrary.org/obo/IAO_0000111": "document".freeze,
            "http://purl.obolibrary.org/obo/IAO_0000112": ["A journal article, patent application, laboratory notebook, or a book".freeze,"Short Definition from the bibo ontology".freeze],
            "http://purl.obolibrary.org/obo/IAO_0000114": "http://purl.obolibrary.org/obo/IAO_0000120".freeze,
            "http://purl.obolibrary.org/obo/IAO_0000115": ["A bounded physical representation of a body of information designed with the capacity (and usually intent) to communicate".freeze,"A collection of information content entities intended to be understood together as a whole".freeze],
            "http://purl.obolibrary.org/obo/IAO_0000117": "PERSON: Lawrence Hunter".freeze,
            "http://purl.obolibrary.org/obo/IAO_0000412": "http://purl.obolibrary.org/obo/iao.owl".freeze,
            isDefinedBy: "http://purl.org/ontology/bibo/".freeze,
            ...
            subClassOf: [term(
              ...
              allValuesFrom: "http://www.w3.org/2000/01/rdf-schema#Literal".freeze,
              onProperty: "http://purl.org/ontology/bibo/numPages".freeze,
              type: "http://www.w3.org/2002/07/owl#Restriction".freeze
            ).freeze,term(
              allValuesFrom: "http://vivoweb.org/ontology/core#Dataset".freeze,
              onProperty: "http://purl.org/spar/cito/citesAsDataSource".freeze,
              type: "http://www.w3.org/2002/07/owl#Restriction".freeze
            ).freeze,term(
              allValuesFrom: "http://purl.org/spar/c4o/GlobalCitationCount".freeze,
              onProperty: "http://purl.org/spar/c4o/hasGlobalCitationFrequency".freeze,
              type: "http://www.w3.org/2002/07/owl#Restriction".freeze
            ).freeze,"http://purl.obolibrary.org/obo/IAO_0000030".freeze,term(
              allValuesFrom: "http://xmlns.com/foaf/0.1/Agent".freeze,
              onProperty: "http://vivoweb.org/ontology/core#features".freeze,
              type: "http://www.w3.org/2002/07/owl#Restriction".freeze
            ).freeze],
            type: "http://www.w3.org/2002/07/owl#Class".freeze
          ))
