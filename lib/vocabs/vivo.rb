  ...
  class VIVO < RDF::StrictVocabulary("http://vivoweb.org/ontology/core#")
    ...
    term :AcademicDegree,
      ...
      subClassOf: ["skos:Concept".freeze, term(
          allValuesFrom: "rdfs:Literal".freeze,
          onProperty: "vivo:abbreviation".freeze,
          type: "owl:Restriction".freeze
        ), term(
          onProperty: "vivo:abbreviation".freeze,
          "owl:minQualifiedCardinality": "1".freeze,
          "owl:onDataRange": "xsd:nonNegativeInteger".freeze,
          type: "owl:Restriction".freeze
        )],
      type: "owl:Class".freeze
    ...
    term :AdvisingRelationship,
      ...
      subClassOf: ["vivo:Relationship".freeze, term(
          allValuesFrom: "owl:Thing".freeze,
          onProperty: "vivo:hasSubjectArea".freeze,
          type: "owl:Restriction".freeze
        ), term(
          allValuesFrom: "vivo:DateTimeInterval".freeze,
          onProperty: "vivo:dateTimeInterval".freeze,
          type: "owl:Restriction".freeze
        ), term(
          onProperty: "vivo:relates".freeze,
          someValuesFrom: "foaf:Person".freeze,
          type: "owl:Restriction".freeze
        ), term(
          onProperty: "vivo:relates".freeze,
          someValuesFrom: "vivo:AdviseeRole".freeze,
          type: "owl:Restriction".freeze
        ), term(
          onProperty: "vivo:relates".freeze,
          someValuesFrom: "vivo:AdvisorRole".freeze,
          type: "owl:Restriction".freeze
        )],
      type: "owl:Class".freeze
    term :AdvisorRole,
    ...
    term :Authorship,
      ...
      subClassOf: ["vivo:Relationship".freeze, term(
          allValuesFrom: "xsd:boolean".freeze,
          onProperty: "vivo:hideFromDisplay".freeze,
          type: "owl:Restriction".freeze
        ), term(
          onProperty: "vivo:relates".freeze,
          someValuesFrom: "foaf:Agent".freeze,
          type: "owl:Restriction".freeze
        ), term(
          onProperty: "vivo:relates".freeze,
    ...
    term :AwardReceipt,
      ...
      subClassOf: ["vivo:Relationship".freeze, term(
          allValuesFrom: "foaf:Organization".freeze,
          onProperty: "vivo:assignedBy".freeze,
          type: "owl:Restriction".freeze
        ), term(
          allValuesFrom: "rdfs:Literal".freeze,
          onProperty: "vivo:description".freeze,
          type: "owl:Restriction".freeze
        ), term(
          allValuesFrom: "vivo:DateTimeInterval".freeze,
          onProperty: "vivo:dateTimeInterval".freeze,
          ...
          allValuesFrom: "vivo:DateTimeValue".freeze,
          onProperty: "vivo:dateTimeValue".freeze,
          type: "owl:Restriction".freeze
        ), term(
          onProperty: "vivo:relates".freeze,
          someValuesFrom: "foaf:Agent".freeze,
          ...
          onProperty: "vivo:relates".freeze,
          someValuesFrom: "vivo:Award".freeze,
          type: "owl:Restriction".freeze
        )],
      type: "owl:Class".freeze
    term :AwardedDegree,
      ...
      subClassOf: ["vivo:Relationship".freeze, term(
          ...
          onProperty: "vivo:relates".freeze,
          someValuesFrom: "vivo:AcademicDegree".freeze,
          type: "owl:Restriction".freeze
        )],
      type: "owl:Class".freeze
    term :Blog,
    ...
    term :BlogPosting,
      ...
      subClassOf: ["bibo:Article".freeze, term(
          allValuesFrom: "vivo:Blog".freeze,
          onProperty: "vivo:hasPublicationVenue".freeze,
          type: "owl:Restriction".freeze
        )],
      type: "owl:Class".freeze
    term :Building,
      ...
      subClassOf: ["vivo:Facility".freeze, term(
          allValuesFrom: "vivo:Facility".freeze,
          onProperty: "http://purl.obolibrary.org/obo/BFO_0000050".freeze,
          type: "owl:Restriction".freeze
        ), term(
          allValuesFrom: "vivo:Room".freeze,
    ...
    term :Catalog,
      ...
      subClassOf: ["bibo:Document".freeze, term(
          allValuesFrom: "foaf:Organization".freeze,
          onProperty: "vivo:publisher".freeze,
          type: "owl:Restriction".freeze
        ), term(
          allValuesFrom: "rdfs:Literal".freeze,
          onProperty: "vivo:placeOfPublication".freeze,
          type: "owl:Restriction".freeze
        )],
      type: "owl:Class".freeze
    term :Center,
    ...
    term :ConferencePaper,
      ...
      subClassOf: ["bibo:Article".freeze, term(
          allValuesFrom: "bibo:Conference".freeze,
          onProperty: "bibo:presentedAt".freeze,
          type: "owl:Restriction".freeze
        )],
      type: "owl:Class".freeze
    ...
    term :Contract,
      ...
      subClassOf: ["vivo:Relationship".freeze, term(
          ...
          onProperty: "vivo:supportedInformationResource".freeze,
          type: "owl:Restriction".freeze
        ), term(
          allValuesFrom: "rdfs:Literal".freeze,
          onProperty: "bibo:abstract".freeze,
          type: "owl:Restriction".freeze
        ), term(
          allValuesFrom: "vivo:DateTimeInterval".freeze,
          onProperty: "vivo:dateTimeInterval".freeze,
    ...
    term :Course,
      ...
      subClassOf: ["http://purl.org/NET/c4dm/event.owl#Event".freeze, term(
          allValuesFrom: "rdfs:Literal".freeze,
          onProperty: "vivo:courseCredits".freeze,
          type: "owl:Restriction".freeze
        )],
      type: "owl:Class".freeze
    term :Credential,
      ...
      subClassOf: ["skos:Concept".freeze, term(
          allValuesFrom: "foaf:Organization".freeze,
          onProperty: "vivo:hasGoverningAuthority".freeze,
          type: "owl:Restriction".freeze
        ), term(
          allValuesFrom: "owl:Thing".freeze,
          onProperty: "vivo:hasSubjectArea".freeze,
          ...
          allValuesFrom: "vivo:GeographicLocation".freeze,
          onProperty: "vivo:validIn".freeze,
          type: "owl:Restriction".freeze
        )],
      type: "owl:Class".freeze
    term :Database,
    ...
    term :EducationalProcess,
      ...
      subClassOf: ["http://purl.obolibrary.org/obo/BFO_0000015".freeze, term(
          ...
          allValuesFrom: "xsd:string".freeze,
          onProperty: "vivo:supplementalInformation".freeze,
          type: "owl:Restriction".freeze
        )],
      type: "owl:Class".freeze
    ...
    term :Equipment,
      ...
      subClassOf: ["http://purl.obolibrary.org/obo/BFO_0000040".freeze, term(
          allValuesFrom: "xsd:string".freeze,
          onProperty: "vivo:freetextKeyword".freeze,
          type: "owl:Restriction".freeze
        )],
      type: "owl:Class".freeze
    term :EventSeries,
      ...
      subClassOf: ["http://purl.obolibrary.org/obo/BFO_0000015".freeze, term(
          ...
          allValuesFrom: "rdfs:Literal".freeze,
          onProperty: "vivo:contactInformation".freeze,
          type: "owl:Restriction".freeze
        ), term(
          allValuesFrom: "rdfs:Literal".freeze,
          onProperty: "vivo:description".freeze,
    ...
    term :FundingOrganization,
      equivalentClass: term(
          onProperty: "vivo:assigns".freeze,
          someValuesFrom: "vivo:Grant".freeze,
          type: "owl:Restriction".freeze
        ),
    ...
    term :GeographicLocation,
      ...
      subClassOf: ["vivo:Location".freeze, term(
          allValuesFrom: "vivo:GeographicLocation".freeze,
          onProperty: "http://purl.obolibrary.org/obo/BFO_0000050".freeze,
          type: "owl:Restriction".freeze
        ), term(
    ...
    term :IssuedCredential,
      ...
      subClassOf: ["vivo:Relationship".freeze, term(
          ...
          allValuesFrom: "vivo:DateTimeValue".freeze,
          onProperty: "vivo:dateIssued".freeze,
          type: "owl:Restriction".freeze
        ), term(
          allValuesFrom: "vivo:DateTimeValue".freeze,
          onProperty: "vivo:expirationDate".freeze,
          type: "owl:Restriction".freeze
        ), term(
          allValuesFrom: "vivo:GeographicLocation".freeze,
          onProperty: "vivo:validIn".freeze,
          ...
          onProperty: "vivo:relates".freeze,
          someValuesFrom: "vivo:Credential".freeze,
          type: "owl:Restriction".freeze
        )],
      type: "owl:Class".freeze
    term :Laboratory,
    ...
    term :Position,
      ...
      subClassOf: ["vivo:Relationship".freeze, term(
          ...
          allValuesFrom: "xsd:int".freeze,
          onProperty: "vivo:rank".freeze,
          type: "owl:Restriction".freeze
        ), term(
          onProperty: "vivo:relates".freeze,
          someValuesFrom: "foaf:Organization".freeze,
          type: "owl:Restriction".freeze
        ), term(
          onProperty: "vivo:relates".freeze,
          someValuesFrom: "foaf:Person".freeze,
    ...
    term :Project,
      ...
      subClassOf: ["http://purl.obolibrary.org/obo/BFO_0000015".freeze, term(
          ...
          allValuesFrom: "vivo:GeographicRegion".freeze,
          onProperty: "vivo:geographicFocus".freeze,
          type: "owl:Restriction".freeze
        )],
      type: "owl:Class".freeze
    term :Publisher,
    ...
    property :assignedBy,
      ...
      inverseOf: "vivo:assigns".freeze,
      label: "assigned by".freeze,
      type: "owl:ObjectProperty".freeze
    property :assignee,
      domain: "bibo:Patent".freeze,
      inverseOf: "vivo:assigneeFor".freeze,
    ...
    property :conceptAssociatedWith,
      inverseOf: "vivo:hasAssociatedConcept".freeze,
    ...
    property :contributingRole,
      inverseOf: "vivo:roleContributesTo".freeze,
    ...
    property :distributesFundingFrom,
      ...
      inverseOf: "vivo:providesFundingThrough".freeze,
    ...
    property :equipmentFor,
      ...
      inverseOf: "vivo:hasEquipment".freeze,
    ...
    property :facilityFor,
      ...
      inverseOf: "vivo:hasFacility".freeze,
      type: "owl:ObjectProperty".freeze
    property :featuredIn,
      ...
      inverseOf: "vivo:features".freeze,
    ...
    property :governingAuthorityFor,
      domain: "foaf:Organization".freeze,
      inverseOf: "vivo:hasGoverningAuthority".freeze,
      label: "governing authority for".freeze,
      type: "owl:ObjectProperty".freeze
    property :grantDirectCosts,
      domain: term(
          type: "owl:Class".freeze,
          unionOf: list("vivo:Contract".freeze, "vivo:Grant".freeze)
        ),
      label: "direct costs".freeze,
      type: ["owl:DatatypeProperty".freeze, "owl:FunctionalProperty".freeze]
    property :grantSubcontractedThrough,
      domain: "vivo:Grant".freeze,
      inverseOf: "vivo:subcontractsGrant".freeze,
    ...
    property :informationResourceSupportedBy,
      ...
      inverseOf: "vivo:supportedInformationResource".freeze,
    ...
    property :publisher,
      ...
      inverseOf: "vivo:publisherOf".freeze,
      label: "publisher".freeze,
      range: "foaf:Organization".freeze,
      type: "owl:ObjectProperty".freeze
    ...
    property :sponsoredBy,
      ...
      inverseOf: "vivo:sponsors".freeze,
    ...
    property :supportedBy,
      ...
      inverseOf: "vivo:supports".freeze,
      label: "supported by".freeze,
      type: "owl:ObjectProperty".freeze
    ...
    property :translatorOf,
      ...
      range: term(
          ...
          unionOf: list(term(
            ...
            "http://purl.obolibrary.org/obo/IAO_0000112": ["Hill Ornithology Collection; Wiley Interscience Online Books Biochemisty Collection".freeze,"Collection of information resources that have a unified identity. Archives, museums and libraries often acquire collections on specific subjects and from distinguished authors or researchers. Also includes collections of resources bundled into a license.".freeze],
            ...
            subClassOf: [term(
              allValuesFrom: "rdfs:Literal".freeze,
              onProperty: "bibo:oclcnum".freeze,
              type: "owl:Restriction".freeze
            ),"http://purl.obolibrary.org/obo/IAO_0000030".freeze],
            type: "owl:Class".freeze,
            ...
            "http://purl.obolibrary.org/obo/IAO_0000112": ["Short Definition from the bibo ontology".freeze,"A journal article, patent application, laboratory notebook, or a book".freeze],
            ...
            subClassOf: [term(
              allValuesFrom: "rdfs:Literal".freeze,
              onProperty: "bibo:numPages".freeze,
              type: "owl:Restriction".freeze
            ),term(
              allValuesFrom: "foaf:Agent".freeze,
              onProperty: "vivo:features".freeze,
              type: "owl:Restriction".freeze
            ),term(
              allValuesFrom: "vivo:Dataset".freeze,
              ...
              type: "owl:Restriction".freeze
            ),"http://purl.obolibrary.org/obo/IAO_0000030".freeze,term(
              allValuesFrom: "rdfs:Literal".freeze,
              onProperty: "bibo:abstract".freeze,
              type: "owl:Restriction".freeze
            ),term(
