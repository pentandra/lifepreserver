...
module LifePreserver::Vocab
  FABIO = Class.new(RDF::StrictVocabulary("http://purl.org/spar/fabio/")) do
    ...
    ontology :"http://purl.org/spar/fabio/",
      ...
      "http://www.w3.org/2002/07/owl#imports": "http://purl.org/spar/frbr".freeze,
      "http://www.w3.org/2002/07/owl#priorVersion": "http://purl.org/spar/fabio/2018-05-02".freeze,
      "http://www.w3.org/2002/07/owl#versionIRI": "http://purl.org/spar/fabio/2019-02-19".freeze,
      "http://www.w3.org/2002/07/owl#versionInfo": "2.1".freeze,
    ...
    term :Abstract,
      ...
      "http://www.w3.org/2000/01/rdf-schema#seeAlso": "http://purl.org/spar/fabio/StructuredSummary".freeze,
      "http://www.w3.org/2002/07/owl#disjointWith": "http://purl.org/spar/fabio/StructuredSummary".freeze,
      label: "abstract".freeze,
      subClassOf: "http://purl.org/spar/fabio/Expression".freeze,
    ...
    term :AcademicProceedings,
      ...
      subClassOf: ["http://purl.org/spar/fabio/ExpressionCollection".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/ProceedingsPaper".freeze,
    ...
    term :Algorithm,
      ...
      subClassOf: "http://purl.org/spar/fabio/Specification".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :AnalogItem,
      ...
      "http://purl.org/dc/elements/1.1/description": "An analog item is an exemplar of an analog manifestation only and it is always stored in a storage medium suitable for analog objects, such as paper, vinyl discs and films.".freeze,
      "http://www.w3.org/2002/07/owl#disjointWith": "http://purl.org/spar/fabio/DigitalItem".freeze,
      label: "analog item".freeze,
      subClassOf: ["http://purl.org/spar/fabio/Item".freeze, term(
          onProperty: "http://purl.org/spar/fabio/isStoredOn".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/AnalogStorageMedium".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://purl.org/vocab/frbr/core#exemplarOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/AnalogManifestation".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :AnalogManifestation,
      comment: "A manifestation in an analog form.".freeze,
      "http://www.w3.org/2002/07/owl#disjointWith": "http://purl.org/spar/fabio/DigitalManifestation".freeze,
      label: "analog manifestation".freeze,
      subClassOf: ["http://purl.org/spar/fabio/Manifestation".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#exemplar".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/AnalogItem".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :AnalogStorageMedium,
      ...
      subClassOf: ["http://purl.org/spar/fabio/StorageMedium".freeze, term(
          allValuesFrom: "http://purl.org/spar/fabio/AnalogItem".freeze,
          onProperty: "http://purl.org/spar/fabio/stores".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Announcement,
      ...
      subClassOf: "http://purl.org/spar/fabio/Work".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Anthology,
      ...
      subClassOf: "http://purl.org/spar/fabio/ExpressionCollection".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :ApplicationProfile,
      ...
      subClassOf: "http://purl.org/spar/fabio/Metadata".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :ApplicationProgrammingInterface,
      ...
      subClassOf: "http://purl.org/spar/fabio/ComputerProgram".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :ArchivalDocumentSet,
      ...
      subClassOf: ["http://purl.org/spar/fabio/ExpressionCollection".freeze, term(
          allValuesFrom: "http://purl.org/spar/fabio/ArchivalDocument".freeze,
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/ArchivalDocument".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :ArchivalRecord,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Work".freeze, term(
          allValuesFrom: "http://purl.org/spar/fabio/ArchivalDocument".freeze,
    ...
    term :ArchivalRecordSet,
      ...
      subClassOf: ["http://purl.org/spar/fabio/WorkCollection".freeze, term(
          allValuesFrom: "http://purl.org/spar/fabio/ArchivalDocumentSet".freeze,
          onProperty: "http://purl.org/vocab/frbr/core#realization".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://purl.org/spar/fabio/ArchivalRecord".freeze,
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/ArchivalRecord".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Article,
    ...
    term :AudioDocument,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/SoundRecording".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :AuthorityFile,
      ...
      subClassOf: "http://purl.org/spar/fabio/ControlledVocabulary".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :BachelorsThesis,
      ...
      subClassOf: "http://purl.org/spar/fabio/Thesis".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :BibliographicDatabase,
      ...
      subClassOf: "http://purl.org/spar/fabio/Database".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :Blog,
      ...
      label: "blog".freeze,
      subClassOf: "http://purl.org/spar/fabio/WebManifestation".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :BlogPost,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Entry".freeze, "http://purl.org/spar/fabio/WebContent".freeze],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Book,
    ...
    term :BookChapter,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Chapter".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#partOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Book".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :BookReview,
      ...
      subClassOf: "http://purl.org/spar/fabio/Review".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :BookSeries,
      ...
      "http://www.w3.org/2002/07/owl#disjointWith": "http://purl.org/spar/fabio/BookSet".freeze,
      label: "book series".freeze,
      subClassOf: ["http://purl.org/spar/fabio/Series".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Book".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
    ...
    term :BriefReport,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          type: "http://www.w3.org/2002/07/owl#Class".freeze,
          unionOf: list("http://purl.org/spar/fabio/RapidCommunication".freeze, "http://purl.org/spar/fabio/ReportDocument".freeze)
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :CallForApplications,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Proposition".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :CaseForSupport,
    ...
    term :CaseForSupportDocument,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/CaseForSupport".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :CaseReport,
      ...
      subClassOf: "http://purl.org/spar/fabio/Report".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Catalog,
    ...
    term :ClinicalCaseReport,
      ...
      subClassOf: "http://purl.org/spar/fabio/CaseReport".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :ClinicalGuideline,
      ...
      subClassOf: "http://purl.org/spar/fabio/InstructionalWork".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :CompleteWorks,
      ...
      subClassOf: "http://purl.org/spar/fabio/CollectedWorks".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :ComputerFile,
      ...
      subClassOf: "http://purl.org/spar/fabio/DigitalItem".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :ConferencePaper,
      ...
      subClassOf: "http://purl.org/spar/fabio/ProceedingsPaper".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :ConferenceProceedings,
      ...
      subClassOf: ["http://purl.org/spar/fabio/AcademicProceedings".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/ConferencePaper".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :ControlledVocabulary,
      ...
      subClassOf: "http://purl.org/spar/fabio/Vocabulary".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Correction,
    ...
    term :Corrigendum,
      ...
      subClassOf: "http://purl.org/spar/fabio/Correction".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Cover,
    ...
    term :DataFile,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Dataset".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :DataManagementPolicy,
      ...
      subClassOf: "http://purl.org/spar/fabio/Policy".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :DataManagementPolicyDocument,
      ...
      subClassOf: "http://purl.org/spar/fabio/PolicyDocument".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :DataRepository,
      ...
      subClassOf: "http://purl.org/spar/fabio/Repository".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Database,
    ...
    term :DefinitiveVersion,
      ...
      subClassOf: "http://purl.org/spar/fabio/Manuscript".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :DemoPaper,
    ...
    term :Diary,
      ...
      label: "diary".freeze,
      subClassOf: ["http://purl.org/spar/fabio/Notebook".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Entry".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :DigitalItem,
      comment: "A digital object, such as a computer file.".freeze,
      "http://purl.org/dc/elements/1.1/description": "A digital item is an exemplar of a digital manifestation only and it is always stored in a storage medium suitable for digital objects, such as CDs, DVDs, HDs and the Web.".freeze,
      label: "digital item".freeze,
      subClassOf: ["http://purl.org/spar/fabio/Item".freeze, term(
          onProperty: "http://purl.org/spar/fabio/isStoredOn".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/DigitalStorageMedium".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://purl.org/vocab/frbr/core#exemplarOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/DigitalManifestation".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :DigitalManifestation,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Manifestation".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#exemplar".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/DigitalItem".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :DigitalStorageMedium,
      ...
      subClassOf: ["http://purl.org/spar/fabio/StorageMedium".freeze, term(
          allValuesFrom: "http://purl.org/spar/fabio/DigitalItem".freeze,
          onProperty: "http://purl.org/spar/fabio/stores".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :DisciplineDictionary,
      ...
      "http://www.w3.org/2002/07/owl#disjointWith": "http://purl.org/spar/fabio/TermDictionary".freeze,
      label: "discipline dictionary".freeze,
      subClassOf: ["http://www.w3.org/2004/02/skos/core#ConceptScheme".freeze, term(
          allValuesFrom: "http://purl.org/spar/fabio/SubjectDiscipline".freeze,
          onProperty: "http://purl.org/spar/fabio/isSchemeOf".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :DoctoralThesis,
    ...
    term :Editorial,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Opinion".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Email,
    ...
    term :ExecutiveSummary,
      ...
      subClassOf: "http://purl.org/spar/fabio/BriefReport".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :Expression,
      ...
      "http://purl.org/dc/elements/1.1/description": "A fabio:Expression can only have part or be part of another fabio:Expression.  Moreover, it can be a representation only of a fabio:Work, and  it can be embodied only in fabio:Manifestation(s).".freeze,
      label: "expression".freeze,
      subClassOf: ["http://purl.org/vocab/frbr/core#Expression".freeze, term(
          allValuesFrom: "http://purl.org/spar/fabio/Manifestation".freeze,
          onProperty: "http://purl.org/vocab/frbr/core#embodiment".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://purl.org/spar/fabio/Work".freeze,
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
    ...
    term :ExpressionCollection,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Expression".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Figure,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/StillImage".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Film,
      ...
      label: "film".freeze,
      subClassOf: "http://purl.org/spar/fabio/Movie".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Folksonomy,
      ...
      subClassOf: "http://purl.org/spar/fabio/UncontrolledVocabulary".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :GanttChart,
    ...
    term :GrantApplicationDocument,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/GrantApplication".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Hardback,
      ...
      subClassOf: "http://purl.org/spar/fabio/PrintObject".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Image,
    ...
    term :InBrief,
      ...
      subClassOf: ["http://purl.org/spar/fabio/NewsItem".freeze, term(
          type: "http://www.w3.org/2002/07/owl#Class".freeze,
          unionOf: list("http://purl.org/spar/fabio/JournalNewsItem".freeze, "http://purl.org/spar/fabio/MagazineNewsItem".freeze)
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :InUsePaper,
      ...
      subClassOf: "http://purl.org/spar/fabio/ScholarlyWork".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Index,
    ...
    term :InstructionManual,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/InstructionalWork".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :Item,
      ...
      "http://purl.org/dc/elements/1.1/description": "A fabio:Item can only have part or be part of another fabio:Item. Moreover, it can be an exemplar only of a fabio:Manifestation.".freeze,
      label: "item".freeze,
    ...
    term :ItemCollection,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Item".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Item".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Journal,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Periodical".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/JournalIssue".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/JournalVolume".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :JournalArticle,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Article".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#partOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/JournalIssue".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
    ...
    term :JournalEditorial,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Editorial".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#partOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/JournalIssue".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
    ...
    term :JournalIssue,
      ...
      subClassOf: ["http://purl.org/spar/fabio/PeriodicalIssue".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#partOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/JournalVolume".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
    ...
    term :JournalVolume,
      ...
      subClassOf: ["http://purl.org/spar/fabio/PeriodicalVolume".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#partOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Journal".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :LaboratoryNotebook,
      ...
      subClassOf: "http://purl.org/spar/fabio/Notebook".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :LectureNotes,
    ...
    term :LegalOpinion,
      ...
      subClassOf: "http://purl.org/spar/fabio/Opinion".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Letter,
    ...
    term :LibraryCatalog,
      ...
      subClassOf: "http://purl.org/spar/fabio/Catalog".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :LiteraryArtisticWork,
      ...
      subClassOf: "http://purl.org/spar/fabio/ArtisticWork".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Magazine,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Periodical".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/MagazineIssue".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :MagazineIssue,
      ...
      subClassOf: ["http://purl.org/spar/fabio/PeriodicalIssue".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#partOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Magazine".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :Manifestation,
      ...
      "http://purl.org/dc/elements/1.1/description": "A fabio:Manifestation can only have part or be part of another fabio:Manifestation.  Moreover, it can be an embodiment only of a fabio:Expression and it can be exemplified only by fabio:Item(s).".freeze,
      label: "manifestation".freeze,
      subClassOf: ["http://purl.org/vocab/frbr/core#Manifestation".freeze, term(
          allValuesFrom: "http://purl.org/spar/fabio/Expression".freeze,
          onProperty: "http://purl.org/vocab/frbr/core#embodimentOf".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          allValuesFrom: "http://purl.org/spar/fabio/Item".freeze,
          onProperty: "http://purl.org/vocab/frbr/core#exemplar".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          intersectionOf: list(term(
    ...
    term :ManifestationCollection,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Manifestation".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Manifestation".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Manuscript,
    ...
    term :MetadataDocument,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Metadata".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :MethodsPaper,
    ...
    term :Microblog,
      ...
      subClassOf: "http://purl.org/spar/fabio/Blog".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Micropost,
    ...
    term :Movie,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/MovingImage".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :MovingImage,
      ...
      "http://www.w3.org/2002/07/owl#disjointWith": "http://purl.org/spar/fabio/StillImage".freeze,
      label: "moving image".freeze,
      subClassOf: "http://purl.org/spar/fabio/Image".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :MusicalComposition,
      ...
      subClassOf: "http://purl.org/spar/fabio/LiteraryArtisticWork".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :NewsItem,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/NewsReport".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :NewsReport,
    ...
    term :Newspaper,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Periodical".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/NewspaperIssue".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :NewspaperIssue,
      ...
      subClassOf: ["http://purl.org/spar/fabio/PeriodicalIssue".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#partOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Newspaper".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :Notebook,
      ...
      subClassOf: "http://purl.org/spar/fabio/Book".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :NotificationOfReceipt,
      ...
      subClassOf: "http://purl.org/spar/fabio/Announcement".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Novel,
    ...
    term :Obituary,
      ...
      subClassOf: "http://purl.org/spar/fabio/NewsReport".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Ontology,
    ...
    term :OntologyDocument,
      ...
      subClassOf: ["http://purl.org/spar/fabio/VocabularyDocument".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Ontology".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Opinion,
    ...
    term :Page,
      ...
      label: "page".freeze,
      subClassOf: "http://purl.org/spar/fabio/Manifestation".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Paperback,
    ...
    term :PatentApplicationDocument,
      ...
      subClassOf: ["http://purl.org/spar/fabio/SpecificationDocument".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/PatentApplication".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :PatentDocument,
      ...
      subClassOf: ["http://purl.org/spar/fabio/SpecificationDocument".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Patent".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Periodical,
      ...
      subClassOf: ["http://purl.org/spar/fabio/ExpressionCollection".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/PeriodicalIssue".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :PeriodicalIssue,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#partOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Periodical".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :PeriodicalItem,
      ...
      equivalentClass: term(
          intersectionOf: list("http://purl.org/spar/fabio/Expression".freeze, term(
            onProperty: "http://purl.org/vocab/frbr/core#partOf".freeze,
            someValuesFrom: term(
              type: "http://www.w3.org/2002/07/owl#Class".freeze,
              unionOf: list("http://purl.org/spar/fabio/PeriodicalIssue".freeze, "http://purl.org/spar/fabio/PeriodicalVolume".freeze)
            ).freeze,
            type: "http://www.w3.org/2002/07/owl#Restriction".freeze
          )),
          type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :PolicyDocument,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Policy".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :PositionPaper,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Opinion".freeze, "http://purl.org/spar/fabio/ScholarlyWork".freeze],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :PosterPaper,
    ...
    term :PressRelease,
      ...
      subClassOf: "http://purl.org/spar/fabio/NewsItem".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :PrintObject,
      comment: "An analog manifestation in physical printed form, typically on paper.".freeze,
      label: "print object".freeze,
      subClassOf: "http://purl.org/spar/fabio/AnalogManifestation".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :ProjectReportDocument,
      ...
      subClassOf: ["http://purl.org/spar/fabio/ReportDocument".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/ProjectReport".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Proof,
    ...
    term :RapidCommunication,
      ...
      "http://www.w3.org/2000/01/rdf-schema#seeAlso": "http://purl.org/spar/fabio/BriefReport".freeze,
    ...
    term :ReferenceBook,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Book".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/ReferenceWork".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :ReferenceEntry,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Entry".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/ReferenceWork".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
    ...
    term :ReportDocument,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Report".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :ReviewArticle,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Article".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Review".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :ReviewPaper,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Review".freeze, "http://purl.org/spar/fabio/ScholarlyWork".freeze],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :ScholarlyWork,
    ...
    term :Song,
      ...
      label: "song".freeze,
      subClassOf: "http://purl.org/spar/fabio/MusicalComposition".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :SoundRecording,
    ...
    term :SpecificationDocument,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Specification".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Spreadsheet,
    ...
    term :StructuredSummary,
      ...
      subClassOf: ["http://purl.org/spar/fabio/SpecificationDocument".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/MinimalInformationStandard".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :SubjectDiscipline,
      ...
      subClassOf: ["http://www.w3.org/2004/02/skos/core#Concept".freeze, term(
          onProperty: "http://www.w3.org/2004/02/skos/core#inScheme".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/DisciplineDictionary".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :SubjectTerm,
      ...
      subClassOf: ["http://www.w3.org/2004/02/skos/core#Concept".freeze, term(
          onProperty: "http://www.w3.org/2004/02/skos/core#inScheme".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/TermDictionary".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Supplement,
    ...
    term :TableOfContents,
      ...
      subClassOf: "http://purl.org/spar/fabio/Table".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Taxonomy,
    ...
    term :TermDictionary,
      ...
      "http://purl.org/dc/elements/1.1/description": "A term dictionary is a collection of subject terms.".freeze,
      label: "term dictionary".freeze,
      subClassOf: ["http://www.w3.org/2004/02/skos/core#ConceptScheme".freeze, term(
          allValuesFrom: "http://purl.org/spar/fabio/SubjectTerm".freeze,
          onProperty: "http://purl.org/spar/fabio/isSchemeOf".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :Timetable,
      ...
      subClassOf: "http://purl.org/spar/fabio/Dataset".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :TrialReport,
    ...
    term :Tweet,
      ...
      label: "tweet".freeze,
      subClassOf: "http://purl.org/spar/fabio/Micropost".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :VocabularyDocument,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Vocabulary".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    term :VocabularyMappingDocument,
      ...
      subClassOf: ["http://purl.org/spar/fabio/SpecificationDocument".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#realizationOf".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/VocabularyMapping".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :WebArchive,
    ...
    term :WebContent,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Expression".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#embodiment".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/WebManifestation".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :WebManifestation,
      ...
      subClassOf: "http://purl.org/spar/fabio/DigitalManifestation".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :WebPage,
      ...
      subClassOf: ["http://purl.org/spar/fabio/Page".freeze, "http://purl.org/spar/fabio/WebManifestation".freeze],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :WebSite,
    ...
    term :WhitePaper,
      ...
      subClassOf: "http://purl.org/spar/fabio/ReportDocument".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Wiki,
    ...
    term :WikipediaEntry,
      ...
      subClassOf: "http://purl.org/spar/fabio/WikiEntry".freeze,
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :Work,
      ...
      "http://purl.org/dc/elements/1.1/description": "A fabio:Work can only have part or be part of another fabio:Work. Moreover, it can be realized only by fabio:Expression(s).".freeze,
      label: "work".freeze,
      ...
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :WorkCollection,
      "http://purl.org/dc/elements/1.1/creator": "A collection of works.".freeze,
      label: "work collection".freeze,
      subClassOf: ["http://purl.org/spar/fabio/Work".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/Work".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :WorkPackage,
    ...
    term :WorkshopProceedings,
      ...
      subClassOf: ["http://purl.org/spar/fabio/AcademicProceedings".freeze, term(
          onProperty: "http://purl.org/vocab/frbr/core#part".freeze,
          someValuesFrom: "http://purl.org/spar/fabio/WorkshopPaper".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    ...
    property :hasAccessDate,
      ...
      domain: "http://purl.org/spar/fabio/Item".freeze,
    ...
    property :hasCODEN,
      ...
      "http://www.w3.org/2000/01/rdf-schema#seeAlso": "http://en.wikipedia.org/wiki/CODEN".freeze,
    ...
    property :hasDiscipline,
      ...
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class".freeze,
          unionOf: list("http://purl.org/spar/fabio/TermDictionary".freeze, term(
            type: "http://www.w3.org/2002/07/owl#Class".freeze
          ))
        ),
      "http://www.w3.org/2002/07/owl#propertyDisjointWith": "http://purl.org/spar/fabio/isSchemeOf".freeze,
      inverseOf: "http://purl.org/spar/fabio/isDisciplineOf".freeze,
      label: "has discipline".freeze,
      range: "http://purl.org/spar/fabio/SubjectDiscipline".freeze,
    ...
    property :hasManifestation,
      ...
      inverseOf: "http://purl.org/spar/fabio/isManifestationOf".freeze,
    ...
    property :hasNLMJournalTitleAbbreviation,
      ...
      subPropertyOf: ["http://purl.org/dc/terms/identifier".freeze, "http://purl.org/spar/fabio/hasShortTitle".freeze],
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty".freeze
    property :hasNationalLibraryOfMedicineJournalId,
      ...
      range: term(
          "http://www.w3.org/2002/07/owl#onDatatype": "http://www.w3.org/2001/XMLSchema#string".freeze,
          "http://www.w3.org/2002/07/owl#withRestrictions": list(term(
            "http://www.w3.org/2001/XMLSchema#pattern": "[0-9]+".freeze
          )),
    ...
    property :hasPortrayal,
      ...
      inverseOf: "http://purl.org/spar/fabio/isPortrayalOf".freeze,
    ...
    property :hasPrimarySubjectTerm,
      ...
      subPropertyOf: "http://purl.org/spar/fabio/hasSubjectTerm".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    ...
    property :hasPublicationYear,
      ...
      range: "http://www.w3.org/2001/XMLSchema#gYear".freeze,
      subPropertyOf: "http://purl.org/dc/terms/issued".freeze,
      type: ["http://www.w3.org/2002/07/owl#DatatypeProperty".freeze, "http://www.w3.org/2002/07/owl#FunctionalProperty".freeze]
    property :hasRepresentation,
      ...
      inverseOf: "http://purl.org/spar/fabio/isRepresentationOf".freeze,
    ...
    property :hasShortTitle,
      ...
      range: "http://www.w3.org/2001/XMLSchema#string".freeze,
      subPropertyOf: "http://purl.org/dc/terms/title".freeze,
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty".freeze
    ...
    property :hasSubjectTerm,
      ...
      range: "http://purl.org/spar/fabio/SubjectTerm".freeze,
      subPropertyOf: "http://www.w3.org/2002/07/owl#topObjectProperty".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    ...
    property :isDisciplineOf,
      ...
      domain: "http://purl.org/spar/fabio/SubjectDiscipline".freeze,
      "http://www.w3.org/2002/07/owl#propertyDisjointWith": "http://www.w3.org/2004/02/skos/core#inScheme".freeze,
    ...
    property :isSchemeOf,
      ...
      inverseOf: "http://www.w3.org/2004/02/skos/core#inScheme".freeze,
    ...
    property :isStoredOn,
      ...
      domain: "http://purl.org/spar/fabio/Item".freeze,
      inverseOf: "http://purl.org/spar/fabio/stores".freeze,
      label: "is stored on".freeze,
      range: "http://purl.org/spar/fabio/StorageMedium".freeze,
      subPropertyOf: "http://www.w3.org/2002/07/owl#topObjectProperty".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    property :stores,
      comment: "This property relates a storage medium to the fabio:Item stored upon it.".freeze,
      domain: "http://purl.org/spar/fabio/StorageMedium".freeze,
      label: "stores".freeze,
      range: "http://purl.org/spar/fabio/Item".freeze,
      subPropertyOf: "http://www.w3.org/2002/07/owl#topObjectProperty".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    ...
    term :"analog-magnetic-tape",
      ...
      type: ["http://purl.org/spar/fabio/AnalogStorageMedium".freeze, "http://www.w3.org/2002/07/owl#NamedIndividual".freeze]
    term :cd,
      comment: "A non-rewritable optical disc used to store digital data.".freeze,
      label: ["CD".freeze, "compact disk".freeze],
      type: ["http://purl.org/spar/fabio/DigitalStorageMedium".freeze, "http://www.w3.org/2002/07/owl#NamedIndividual".freeze]
    term :cloud,
