...
module LifePreserver::Vocab
  C4O = Class.new(RDF::StrictVocabulary("http://purl.org/spar/c4o/")) do
    ...
    ontology :"http://purl.org/spar/c4o/",
      ...
      "http://purl.org/dc/elements/1.1/date": "2018-06-22".freeze,
      "http://purl.org/dc/elements/1.1/description": ["C4O, the Citation Counting and Context Characterization Ontology (C4O) allows the characterization of bibliographic citations in terms of their number and their context.\n\nIt provides the ontological structures to permit the number of in-text citations of a cited source (i.e. the number of in-text reference pointers to a single reference in the citing article's reference list) to be recorded, and also the number of citations a cited entity has received globally, as determined by a bibliographic information resource such as Google Scholar, Scopus or Web of Knowledge on a particular date.\n\nMoreover, it enables ontological descriptions of the context within the citing document in which an in-text reference pointer appears, and permits that context to be related to relevant textual passages in the cited document.\n".freeze, "http://purl.org/spar/c4o/CitationCounting%20module.png".freeze],
      "http://purl.org/dc/elements/1.1/rights": "This work is distributed under a Creative Commons Attribution 4.0 International license (https://creativecommons.org/licenses/by/4.0/legalcode).".freeze,
      "http://purl.org/dc/elements/1.1/title": "C4O, the Citation Counting and Context Characterization Ontology".freeze,
      "http://www.w3.org/2002/07/owl#imports": "http://purl.org/spar/biro".freeze,
      "http://www.w3.org/2002/07/owl#priorVersion": "http://purl.org/spar/c4o/2013-05-11".freeze,
      "http://www.w3.org/2002/07/owl#versionIRI": "http://purl.org/spar/c4o/2018-06-22".freeze,
    ...
    term :BibliographicInformationSource,
      ...
      "http://www.w3.org/2002/07/owl#disjointWith": ["http://purl.org/spar/c4o/GlobalCitationCount".freeze, "http://purl.org/spar/c4o/InTextReferencePointer".freeze, "http://purl.org/spar/c4o/SingleLocationPointerList".freeze],
    ...
    term :GlobalCitationCount,
      ...
      "http://www.w3.org/2002/07/owl#disjointWith": ["http://purl.org/spar/c4o/InTextReferencePointer".freeze, "http://purl.org/spar/c4o/SingleLocationPointerList".freeze],
    ...
    term :InTextReferencePointer,
      ...
      "http://purl.org/dc/elements/1.1/description": ["An in-text reference pointer is a textual device denoting a single bibliographic reference that is embedded in the text of a document within the context of a particular sentence.".freeze, "http://purl.org/spar/c4o/InTextReferencePointer%20module.png".freeze],
      "http://www.w3.org/2002/07/owl#disjointWith": "http://purl.org/spar/c4o/SingleLocationPointerList".freeze,
      label: "in-text reference pointer".freeze,
      subClassOf: ["http://purl.org/vocab/frbr/core#Expression".freeze, term(
          "http://www.w3.org/2002/07/owl#onClass": "http://purl.org/spar/biro/BibliographicReference".freeze,
          "http://www.w3.org/2002/07/owl#qualifiedCardinality": "1".freeze,
          onProperty: "http://purl.org/spar/c4o/denotes".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          cardinality: "1".freeze,
          onProperty: "http://purl.org/spar/c4o/hasContext".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        )],
      type: "http://www.w3.org/2002/07/owl#Class".freeze
    term :InTextReferencePointerList,
      ...
      "http://purl.org/dc/elements/1.1/description": "An in-text reference pointer list can only contain in-text reference pointer list items, and it always pertains to one or more bibliographic references.".freeze,
      label: "in-text reference pointer list".freeze,
      subClassOf: ["http://purl.org/co/List".freeze, term(
          allValuesFrom: "http://purl.org/spar/c4o/InTextReferencePointerListItem".freeze,
          onProperty: "http://purl.org/co/item".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
          onProperty: "http://purl.org/spar/c4o/pertainsTo".freeze,
    ...
    term :SingleLocationPointerList,
      ...
      "http://purl.org/dc/elements/1.1/description": "A single location pointer list pertains to two or more references occurring at a single location in the text of the citing work - e.g. \"[3,4,9]\" or \"[7-12]\".".freeze,
      "http://www.w3.org/2002/07/owl#disjointWith": "http://purl.org/spar/c4o/SingleReferencePointerList".freeze,
      label: "single location pointer list".freeze,
      subClassOf: ["http://purl.org/spar/c4o/InTextReferencePointerList".freeze, "http://purl.org/vocab/frbr/core#Expression".freeze, term(
          cardinality: "1".freeze,
          onProperty: "http://purl.org/spar/c4o/hasContext".freeze,
          type: "http://www.w3.org/2002/07/owl#Restriction".freeze
        ), term(
    ...
    property :denotes,
      ...
      domain: "http://purl.org/spar/c4o/InTextReferencePointer".freeze,
      inverseOf: "http://purl.org/spar/c4o/isDenotedBy".freeze,
    ...
    property :hasContext,
      ...
      domain: "http://purl.org/spar/c4o/InTextReferencePointer".freeze,
      "http://purl.org/dc/elements/1.1/description": "Any FRBR expression that constitutes the range of this property can have at most one particular literal textual content specified through the property c4o:hasContent.".freeze,
      ...
      range: term(
          intersectionOf: list(term(
            ...
            onProperty: "http://purl.org/spar/c4o/hasContent".freeze,
            type: "http://www.w3.org/2002/07/owl#Restriction".freeze
          )),
          type: "http://www.w3.org/2002/07/owl#Class".freeze
        ),
    ...
    property :hasGlobalCitationFrequency,
      ...
      range: "http://purl.org/spar/c4o/GlobalCitationCount".freeze,
      subPropertyOf: "http://www.w3.org/2002/07/owl#topObjectProperty".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    property :hasGlobalCountDate,
      ...
      domain: "http://purl.org/spar/c4o/GlobalCitationCount".freeze,
    ...
    property :hasGlobalCountSource,
      ...
      range: "http://purl.org/spar/c4o/BibliographicInformationSource".freeze,
      subPropertyOf: "http://www.w3.org/2002/07/owl#topObjectProperty".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    ...
    property :isDenotedBy,
      ...
      range: "http://purl.org/spar/c4o/InTextReferencePointer".freeze,
      subPropertyOf: "http://www.w3.org/2002/07/owl#topObjectProperty".freeze,
      type: "http://www.w3.org/2002/07/owl#ObjectProperty".freeze
    ...
    property :pertainsTo,
      ...
      domain: "http://purl.org/spar/c4o/InTextReferencePointerList".freeze,
