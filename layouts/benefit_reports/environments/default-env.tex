...
\setupexternalfigures
  [location=global,directory={<%= Pathname.new(@item[:filename]).realpath.dirname %>, <%= Pathname.new(@items['/static/assets/images/*'].unwrap.attributes[:filename]).realpath.dirname %>}]
