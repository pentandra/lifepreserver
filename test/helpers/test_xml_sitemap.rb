    ...
    class XMLSitemapTest < Nanoc::TestCase
      ...
      def test_xml_sitemap
        if_have 'nokogiri' do
          ...
          assert_equal '2004-07-11T22:00:00Z',             urls[2].css('> lastmod').inner_text
          assert_equal '2004-07-11T22:00:00Z',             urls[3].css('> lastmod').inner_text
        end
      end
